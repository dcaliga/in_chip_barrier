...
@entire_set = (
    "v1",             "ex_in_chip_barrier", "2000", "yes",
    "v1_solution",    "ex_in_chip_barrier", "2000", "yes",
    "v2",             "ex_in_chip_barrier", "2000", "no",
    "v2_solution",    "ex_in_chip_barrier", "2000", "yes",
     );
...
while (@entire_set) {
	...
	$runt = shift @entire_set;

     print  $dir . "  ----  " . $exec_str . " *****  RUN TEST " . $runt . " *****\n";
	# next;
